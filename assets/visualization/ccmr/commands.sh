...
python assets/visualization/ccmr/code/aggregate_ccmr.py --input assets/visualization/ccmr/data/runs/dit_final assets/visualization/ccmr/data/runs/flux_final --config assets/visualization/ccmr/configs/aggregate.yaml --output-dir assets/visualization/ccmr/data/combined
